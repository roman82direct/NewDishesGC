...
{{--                    @foreach(\App\Models\Good::whereCollectionId($collection_item->id)->get() as $good_item)--}}
{{--                        <div class="col-lg-3 col-md-6 portfolio-item filter-{{ $collection_item->id }}">--}}
{{--                            <div class="portfolio-wrap cardhover card h-100 mb-3">--}}
{{--                                <img src="{{ $good_item->img }}" onError="this.src='/storage/img/good/temp.jpg'" alt="...">--}}
{{--                                <div class="card-links">--}}
{{--                                    <a href="{{ route('nav::showGoodItem', ['id' => $good_item->id]) }}" class="card-link">--}}
...
{{--                                </div>--}}
{{--                                <div class="card-body">--}}
{{--                                    <p class="card-text text-sm">{{ $good_item->name }}</p>--}}
{{--                                </div>--}}
{{--                            </div>--}}
{{--                        </div>--}}
{{--                    @endforeach--}}
