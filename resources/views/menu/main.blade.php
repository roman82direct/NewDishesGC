    ...
    <section id="portfolio" class="portfolio">
        <div class="container">
            ...
            <div class="row portfolio-container mt-4" data-aos="fade-up">
                @foreach(\App\Models\Group::all() as $group_item)
                    @foreach(\App\Models\Category::whereGroupId($group_item->id)->get() as $category_item)
                        <div class="col-lg-3 col-md-6 portfolio-item filter-{{ $group_item->id }}">
...
{{--                                    <p class="card-text">{{ $good_item->art }}</p>--}}
                                </div>
                            </div>
                        </div>
                    @endforeach
